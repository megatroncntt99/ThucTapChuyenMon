<?php
    ...
    $_POST['KeySearch']="thic";
    
   //Search Song 
   
    if(isset($_POST['KeySearch'])){
        $keySearch=$_POST['KeySearch'];
        $querySong="SELECT * FROM `song` WHERE lower(song.nameSong) LIKE '%$keySearch%'";
    ...
    if(isset($_POST['KeySearch'])){
        $keySearch=$_POST['KeySearch'];
        $queryPlaylist="SELECT * FROM `playlist` WHERE lower(playlist.namePlayList) LIKE '%$keySearch%'";
    ...
    if(isset($_POST['KeySearch'])){
        ...
        FROM `mv_music`,`song` 
        WHERE mv_music.idSong=song.idSong AND song.nameSong LIKE '%$keySearch%'";
