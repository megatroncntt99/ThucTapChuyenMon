        ...
        callback.enqueue(new Callback<Search>() {
            ...
            public void onResponse(Call<Search> call, Response<Search> response) {
                ...
                if (playlistArrayList.size() > 0) {
                    ...
                    playlistAdapter = new AllPlaylistAdapter(getActivity(), R.layout.row_item_search_playlist, playlistArrayList);
                    recyclerViewSearchPlaylist.setAdapter(playlistAdapter);
                } else {
                    playlistAdapter = new AllPlaylistAdapter(getActivity(), R.layout.row_item_search_playlist, playlistArrayList);
                    recyclerViewSearchPlaylist.setAdapter(playlistAdapter);
