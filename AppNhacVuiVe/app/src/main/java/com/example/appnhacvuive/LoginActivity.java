...
public class LoginActivity extends AppCompatActivity {
    ...
    RelativeLayout relativeLayoutSong, relativeLayoutPlaylist, relativeLayoutAlbum, relativeLayoutMV;
    ...
    private void addEvent() {
        ...
        relativeLayoutSong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(LoginActivity.this, "Song", Toast.LENGTH_SHORT).show();
            }
        });
    }
